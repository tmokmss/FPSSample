...
public class SoundDef : ScriptableObject
{
    ...
    [Range(-60.0f, 0.0f)] public float volume = -6.0f;

//    public float gain = -60.0f; // could be a lower floor on rolloff func
    [Range(0.1f, 100.0f)] public float distMin = 1.5f;
    [Range(0.1f, 100.0f)] public float distMax = 30.0f;
    [Range(-20, 20.0f)] public float pitchMin = 0.0f;
    [Range(-20, 20.0f)] public float pitchMax = 0.0f;
