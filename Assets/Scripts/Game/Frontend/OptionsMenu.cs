...
abstract public class OptionUI : MonoBehaviour
{
    ...
    [System.NonSerialized] public ConfigVar configVar;

    [System.NonSerialized] public bool changed;
...
public class OptionsMenu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AddDropdown(RenderSettings.rFullscreen, "Full screen mode", new List<string>() {"Windowed", "Full screen", "Exclusive"},
            new List<string>() {"3", "1", "0"});
        ...
        AddDropdown(RenderSettings.rAAMode, "Anti alias mode", new List<string>() {"Off", "FXAA", "SMAA", "TAA"},
            new List<string>() {"off", "fxaa", "smaa", "taa"});

        AddSpace(100.0f);
        AddHeading("Audio settings");
        AddDropdown(SoundSystem.soundMute, "Audio enabled", new List<string>() {"When focus", "Always", "Never"},
