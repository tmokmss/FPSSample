...
public class GameModeSystemClient : ComponentSystem
{
    ...
    protected override void OnUpdate()
    {
        ...
        if (gameMode != null)
        {
            ...
            overlayUI.SetObjectiveProgress(m_LocalPlayer.goalCompletion, (int) m_LocalPlayer.goalAttackers, (int) m_LocalPlayer.goalDefenders,
                Game.game.gameColors[m_LocalPlayer.goalDefendersColor], Game.game.gameColors[m_LocalPlayer.goalAttackersColor]);
        }
