...
public struct
    ServerEntity : IComponentData // TODO (mogensh) move to ReplicatedModule rename to something relevant (as it is now tied to replicated entity predictiongPlayer) 
{
    public int foo;
}
