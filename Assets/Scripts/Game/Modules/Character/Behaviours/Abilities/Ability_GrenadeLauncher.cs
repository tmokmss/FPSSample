...
class GrenadeLauncher_Update : BaseComponentDataSystem<AbilityControl, Ability_GrenadeLauncher.PredictedState, Ability_GrenadeLauncher.Settings>
{
    ...
    protected override void Update(Entity entity, AbilityControl abilityCtrl, Ability_GrenadeLauncher.PredictedState predictedState,
        Ability_GrenadeLauncher.Settings state)
    {
