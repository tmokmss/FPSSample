...
public class AnimGraph_Move8Dir : AnimGraphAsset
{
    ...
    [Range(0f, 1f)] [Tooltip("The max. time between exiting ground move and re-entering, before a state reset is triggered")]
...
//                    Debug.Log("Reset movement run! (Ticks since: " + ticksSincePreviousGroundMove + " Time since: " + timeSincePreviousGroundMove + ")");
            ...
            animState.locomotionVector = Vector2.SmoothDamp(animState.locomotionVector, targetBlend, ref m_CurrentVelocity, m_settings.damping,
                m_settings.maxStep, deltaTime);
