...
public struct CameraNoiseJob : IAnimationJob
{
    ...
    {
        [Range(0f, 1f)] public float dollyMagnitude;
        [Range(0f, 10f)] public float dollySpeed;
        [Range(0f, 1f)] public float panMagnitude;
        [Range(0f, 10f)] public float panSpeed;
        [Range(0f, 1f)] public float pedistalMagnitude;
        [Range(0f, 10f)] public float pedistalSpeed;
        [Range(0f, 1f)] public float bias;
    }
