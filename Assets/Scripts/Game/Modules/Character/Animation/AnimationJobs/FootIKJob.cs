...
public struct FootIkJob : IAnimationJob
{
    ...
    public struct JobSettings
    {
        ...
        [Space(10)] public bool enabled;

        [Space(10)] [Range(0f, 1f)] public float emitRayOffset;
        [Range(0f, 20f)] public float maxRayDistance;
        public bool debugRayCast;

        [Space(10)] [Range(0f, 1f)] public float maxStepSize;
        ...
        [Range(5f, 50f)] public float maxFootRotationOffset;

        [Space(10)] [Range(0f, 1f)] public float enterStateEaseIn;
    }
