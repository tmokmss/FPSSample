...
public struct AimDragJob : IAnimationJob
{
    ...
    {
        [Range(0.0f, 10f)] public float stiffness;
        [Range(0.0f, 180f)] public float maxAngle;
        [Range(-1.0f, 1.0f)] public float dragWeight;
        [Range(-1.0f, 1.0f)] public float rollWeight;
        [Range(0, 10)] public int rollDelay;
